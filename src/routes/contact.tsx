        ...
        <div className="container-narrow grid lg:grid-cols-3 gap-8">
          <div className="space-y-4">
            {[
              ...
              <Card key={c.title} className="p-5 flex items-start gap-4">
                <div className="h-10 w-10 rounded-xl flex items-center justify-center text-white shrink-0" style={{ background: "var(--warm)" }}>
          ...
          <Card className="lg:col-span-2 p-8">
            ...
            <form onSubmit={(e) => { e.preventDefault(); toast.success("Message received, we'll reply within 24 hours."); }} className="mt-6 grid gap-4">
              ...
              <Button type="submit" className="w-fit rounded-full px-8 h-11" style={{ background: "var(--warm)", color: "var(--warm-foreground)" }}>Send message</Button>
            </form>
          </Card>
        </div>
